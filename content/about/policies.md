...
<div class="text-center">
  <a href="#code-of-conduct" class="btn btn-secondary btn-sm my-2" >Code of Conduct</a>
  <a href="#circulation-policies" class="btn btn-secondary btn-sm my-2" >Circulation</a>
  <a href="#building-policies" class="btn btn-secondary btn-sm my-2" >Building</a>
  <a href="#collection-management" class="btn btn-secondary btn-sm my-2" >Collection Management</a>
</div>
...
The library does not collect late fees or fines for items in our general collection as part of our commitment to equitable access to information and student affordability.
Some items in the library, such as <a href="{{ '/services/reserve/' | relative_url }}">print Course Reserves</a> or U of I loanable equipment, are exceptions to this policy and will accrue late fees. 
In addition, the library assesses lost item and replacement fees to patrons.
...
### Degree Program Cost Estimation

Degree programs often require new resources in the Library to meet the needs of teaching, research, and accreditation.
Faculty proposing new academic programs should engage the Library early in the proposal process to ensure there is time to evaluate requirements.
Please review the [Library Cost Estimation Requirements for New Degree Program Proposals policy]({{ '/about/program-cost-estimation.html' | relative_url }}) for details.
