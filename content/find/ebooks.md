...
layout: page
search: true
keywords: ebooks; access tools; library search
...
Many downloaded ebooks have Digital Rights Management software (DRM) that prevents users from sharing files with others and may impose a time limit for use. These ebooks may require using the [Ebook Central Reader app](https://proquest.libguides.com/ebookcentral/appdownload) (Proquest) or the free [Thorium Reader](https://connect.ebsco.com/s/article/EBSCO-eBooks-LCP-Thorium-Frequently-Asked-Questions) (Ebsco) to download the file.
