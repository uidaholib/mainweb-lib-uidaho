...
layout: page
search: true
keywords: scholarly articles; database search; research strategies
...
{% include feature/image.html img="https://www.lib.uidaho.edu/media/tutorials/navigate.jpg" alt="Navigate to Academic Search Premier" caption="Navigate to Academic Search Premier" %}

- Sign in to your account using your U of I email and password.

{% include feature/image.html img="https://www.lib.uidaho.edu/media/tutorials/signin.gif" alt="The sign-in screen" caption="The sign-in screen" %}
...
{% include feature/image.html img="https://www.lib.uidaho.edu/media/tutorials/searchscreen.jpg" alt="Academic Search Premier search screen" caption="Academic Search Premier search screen" %}

- Here's the results page:

{% include feature/image.html img="https://www.lib.uidaho.edu/media/tutorials/resultspage.jpg" alt="Results page" caption="Results page" %}
...
{% include feature/image.html img="https://www.lib.uidaho.edu/media/tutorials/filters.jpg" alt="Academic Search Premier filters" caption="Academic Search Premier filters" %}
...
{% include feature/image.html img="https://www.lib.uidaho.edu/media/tutorials/articlepage.jpg" alt="Article page" caption="Article page" %}
...
{% include feature/image.html img="https://www.lib.uidaho.edu/media/tutorials/ill.gif" alt="Request vie Interlibraryloan" caption="Request vie Interlibraryloan" %}

- In this next example, the full article can be accessed under “View Online” when clicking “check for full text availability.”

{% include feature/image.html img="https://www.lib.uidaho.edu/media/tutorials/viewonline.gif" alt="View Online" caption="View Online" %}
