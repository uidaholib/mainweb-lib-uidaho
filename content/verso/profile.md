...
layout: page
search: true
keywords: verso; profile editing; research profiles
...
{% include feature/image.html img="https://www.lib.uidaho.edu/media/verso/1edit_profile_50.gif" alt="A gif showing use of the top-left 'Edit Profile' button on a VERSO profile's 'overview' tab. The subsequent 'Settings' page contains navigation tabs in a left-sidebar." width="75" %}
...
{% include feature/image.html img="https://www.lib.uidaho.edu/media/verso/3export_all_50.gif" alt="A gif showing use of the 'Export All' button in the top-center of a VERSO profile's 'output' tab." width="75" %}
...
{% include feature/image.html img="https://www.lib.uidaho.edu/media/verso/4_hide_50.gif" alt="A gif showing two things. First, how to use the ellpises dropdowns on a VERSO profile's 'output' tab to hide or unhide a work. Second, how to use the eye icons on a profile's 'Settings' page to hide or unhide researcher information." width="75" %}
