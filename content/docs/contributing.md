...
- Email Website Team broken links, content errors, or other suggestions (always include a link to the page in your email)
- Join annual Web Committee meetings to provide input and feedback.
- Collaborate with Website Team to develop new page or feature ideas.
- Edit content spreadsheets in Google Sheets.
...
Please do not do any updates that change navigation or global options directly in the "main" branch until those updates are ready to go live and are deployed.
...
In general, a few the Website Team members will regularly deploy changes to the live server.
In emergency / urgent situations when main contacts are not available, fall backs are available to deploy with access to the server.
