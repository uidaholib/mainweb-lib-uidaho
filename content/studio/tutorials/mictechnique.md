...
layout: page
search: true
keywords: the studio; microphone technique; podcasting; tutorials
...
{% include feature/image.html img="https://www.lib.uidaho.edu/media/studio/microphone_end.png" alt="A silhouette of a person speaking into the end of a microphone." caption="Speak into the end of a microphone." width="50%" %}
