...
layout: page
search: true
keywords: the studio; rodecaster pro ii; podcast recording
...
{% include feature/image.html img="https://www.lib.uidaho.edu/media/studio/unity_gain.png" alt="unity gain" caption="A close-up of RØDECaster Pro II with unity gain line" width="30%" %}</li>
 ...
 {% include feature/image.html img="https://www.lib.uidaho.edu/media/studio/level_meter.png" alt="Level meter" caption="level meter" width="8%"%}
  <ul>
...
{% include feature/image.html img="https://www.lib.uidaho.edu/media/studio/rode_headphone_volume.png" alt="Headphone knobs" caption="Headphone knobs" width="35%" %}
...
{% include feature/image.html img="https://www.lib.uidaho.edu/media/studio/show_icon.png" alt="Show icon" caption="Show icon" width="40%" %}
 </li>
 <li>Select Recordings to view a list of files.
 
{% include feature/image.html img="https://www.lib.uidaho.edu/media/studio/rode_recordings.png" alt="Recordings" caption="Recordings" width="30%" %}
 </li>
...
{% include feature/image.html img="https://www.lib.uidaho.edu/media/studio/blue_port.png" alt="Blue ports on the Anker Data Hub" caption="Blue ports on the Anker Data Hub" width="35%" %}
 </li>
